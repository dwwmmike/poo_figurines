      ...
      <div class="card mt-2">
        ...
        <div class="card-body">
          <form action="<?php $_SERVER['PHP_SELF']  ?>" method="post">
            ...
            <label for="objet">Objet de la commande*</label>
           ...
           <button type="submit" name="submit" class="mt-2 btn btn-primary col-12"><i class="far fa-check-square"></i> Envoyer</button>
          </form>
